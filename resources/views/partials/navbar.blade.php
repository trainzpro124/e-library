    ...
    @auth
        ...
        <div x-show="isOpen" class="md:hidden" id="mobile-menu">
            <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                ...
                @auth
                    <a href="/borrows/{{ auth()->user()->slug }}" class="block rounded-md px-3 py-2 text-base font-medium {{ request()->is('borrows*') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">Borrows</a>
                @endauth
